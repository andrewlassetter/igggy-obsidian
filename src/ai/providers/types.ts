...
import type { TranscriptAnalysis, TranscriptMeta, NoteContent, NotePreferences, NoteType } from '@igggy/core'
...
export interface SummarizeOptions {
  ...
  forcedType?: NoteType        // override AI type detection
  speakerNames?: Record<string, string> // label → name mapping for speaker attribution
}
